...
async def get_bucket_stats() -> Tuple[HTTPStatus, Dict[str, Any]]:
    ...
    status, body = await rgwcli.signed_http_request(
        ...
        'GET', '/admin/bucket/?stats', query_params=user_params)
...
if __name__ == "__main__":
    ...
    status, user_info = loop.run_until_complete(get_bucket_stats())
